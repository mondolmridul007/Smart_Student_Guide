...
public class StudentTeacherAdapter extends RecyclerView.Adapter<StudentTeacherAdapter.TeacherViewAdapter> {

    private List<StudentTeacherData> list;
    private Context context;

    public StudentTeacherAdapter(List<StudentTeacherData> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull TeacherViewAdapter holder, int position) {
        StudentTeacherData item = list.get(position);
